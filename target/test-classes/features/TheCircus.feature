@imdb
Feature: Menude bulunan film ile arama cubugu uzerinden bulunan filmm ozellikleri ayni olmalidir.


  Scenario: The Circus filmi menu uzerimnden bulunur ve bu film arama cubugundan aratilir. Director, Writer, Stars bilgilerinin ayni oldugu dogrilanir.
    ...
    And  Honorary Award basligi altinda The Circus secilir
    ...
    And  Arama cubuguna The Circus yazilir
    And  Sonuclar arasinda gelen The Circus'a tiklanir
    ...
    And  Gelen ekranda butun fotograflarin linklerinin kirik olamadigi test edilir
